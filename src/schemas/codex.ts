...
const CodexMessageContent = z.array(
  z.object({
    type: z.string(),
...
export type CodexSessionMeta = z.infer<typeof CodexSessionMeta>;
export type CodexResponseItem = z.infer<typeof CodexResponseItem>;
export type CodexEventMsg = z.infer<typeof CodexEventMsg>;
export type CodexTurnContext = z.infer<typeof CodexTurnContext>;
export type CodexIndexEntry = z.infer<typeof CodexIndexEntry>;
